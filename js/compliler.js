...
// step2.5 upload grammar rules
function uploadGrammar(){

}

// step3 show grammar parser table
function grammarParserTableDisplay(){

}

// step4 show process step by step


// step5 display the grammar tree
function grammarTreeDisplay(grammarTreeData){
    drawGrammarTree(grammarTreeData, 760, 480);
}
 ...
 */
 function test() {
    ...
    drawGrammarTree(gA.getGrammarTreeData,760,480);
}